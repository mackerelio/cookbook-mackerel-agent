...
namespace :vagrant do
  task :make, %i[machine target] => %i[up provision]
  task :remake, %i[machine target] => %i[clean up provision]

  task :up, [:machine] => [:setup] do |_t, args|
    prepare_args! args
  ...
  task :provision, [:machine] => [:setup] do |_t, args|
    prepare_args! args
    args.machines.each do |machine|
  ...
  task :clean, [:machine] => [:setup] do |_t, args|
    prepare_args! args
    args.machines.each do |machine|
